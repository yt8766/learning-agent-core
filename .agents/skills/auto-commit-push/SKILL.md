...
execution-hints:
  ...
  - Generate the commit message from the current modifications and keep it aligned with docs/conventions/github-flow.md.
...
- 优先遵守 [GitHub Flow 规范](/Users/dev/Desktop/learning-agent-core/docs/conventions/github-flow.md)
- 不要直接向 `main` 提交或推送
...
3. 生成英文提交信息
   ...
   - 提交信息必须遵守 [GitHub Flow 规范](/Users/dev/Desktop/learning-agent-core/docs/conventions/github-flow.md)
   - 优先使用简洁、可读、目的明确的英文
   - 默认保持单行主题，必要时再补正文
4. 暂存当前所有更改
   - 执行 `git add .`
...
- 优先使用与 [GitHub Flow 规范](/Users/dev/Desktop/learning-agent-core/docs/conventions/github-flow.md) 一致的提交信息
...
- [GitHub Flow 规范](/Users/dev/Desktop/learning-agent-core/docs/conventions/github-flow.md)
- [Requesting Code Review Skill](/Users/dev/Desktop/learning-agent-core/.agents/skills/requesting-code-review/SKILL.md)
