...
import type { FeedSourceRecord, NvdKeywordSourceRecord, SecurityPageSourceRecord } from './briefing-sources';
import type { TechBriefingCategory, TechBriefingItem } from './briefing.types';
import { localizeFeedItem, localizeSecurityItem } from './briefing-localize';
import {
...
export async function collectSecurityPageItems(
  ...
  const page = parseSecurityPage(html, source);
...
function parseSecurityPage(html: string, source: SecurityPageSourceRecord): TechBriefingItem | null {
