...
interface TaskExecutionStepsLike {
...
function normalizeTaskStepCollection(task: TaskExecutionStepsLike) {
  task.executionSteps ??= [];
  return task.executionSteps;
}

function updateChatRouteSummary(task: TaskExecutionStepsLike, route: ExecutionStepRoute) {
  if (!task.chatRoute) {
    return;
  }
...
function upsertStep(task: TaskExecutionStepsLike, route: ExecutionStepRoute, stage: ExecutionStepStage) {
...
export function initializeTaskExecutionSteps(task: TaskExecutionStepsLike) {
