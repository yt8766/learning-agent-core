...
export { buildImpactNote, buildActionNote, itemTypeLabel } from './runtime-tech-briefing-category-rules';
import { buildActionNote } from './runtime-tech-briefing-category-rules';
