...
import { ActionButton, ConnectorFeed } from './connector-card-primitives';
...
function ConnectorBadges({ connector }: { connector: ConnectorRecord }) {
  return (
...
function ConnectorMetadata({ connector }: { connector: ConnectorRecord }) {
  return (
    <>
...
function ConnectorActions(props: ComponentProps<typeof ConnectorCard>) {
  const { connector } = props;
  const isTemplate =
...
function ConnectorCapabilities(props: ComponentProps<typeof ConnectorCard>) {
  const { connector } = props;
  return (
    <>
