...
vi.mock('@/features/run-observatory/run-observatory-compare-card', () => ({
  RunObservatoryCompareCard: () => null
}));

vi.mock('@/features/run-observatory/run-observatory-panel', () => ({
...
vi.mock('@/features/runtime-overview/components/runtime-agent-graph-overlay-card', () => ({
  RuntimeAgentGraphOverlayCard: () => null
}));

vi.mock('@/features/runtime-overview/components/runtime-node-activity-ledger-card', () => ({
  RuntimeNodeActivityLedgerCard: () => null
}));

vi.mock('@/features/runtime-overview/components/runtime-execution-story-card', () => ({
  RuntimeExecutionStoryCard: () => null
}));

vi.mock('@/features/runtime-overview/components/runtime-run-workbench-card', () => ({
  RuntimeRunWorkbenchCard: () => null
}));

vi.mock('@/features/runtime-overview/components/runtime-run-session-timeline-card', () => ({
  RuntimeRunSessionTimelineCard: () => null
}));

vi.mock('@/features/runtime-overview/components/runtime-workflow-execution-map-card', () => ({
  RuntimeWorkflowExecutionMapCard: () => null
}));

vi.mock('@/features/runtime-overview/components/runtime-queue-selected-run-summary', () => ({
  RuntimeQueueSelectedRunSummary: () => null
}));

vi.mock('@/features/runtime-overview/components/runtime-queue-trace-panels', () => ({
  RuntimeQueueTracePanels: () => null
}));

import { RuntimeQueueSelectedRun } from '@/features/runtime-overview/components/runtime-queue-selected-run';
