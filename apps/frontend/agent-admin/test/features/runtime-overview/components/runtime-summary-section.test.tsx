...
vi.mock('@/features/runtime-overview/components/runtime-summary-governance', () => ({
...
vi.mock('@/features/runtime-overview/components/runtime-summary-visuals', () => ({
  RuntimeSummaryVisuals: () => <div>visuals-block</div>
}));
vi.mock('@/features/runtime-overview/components/runtime-summary-briefing-audit', () => ({
  RuntimeSummaryBriefingAudit: () => <div>briefing-audit-block</div>
}));
vi.mock('@/features/runtime-overview/components/runtime-summary-channel-deliveries', () => ({
...
import { RuntimeSummarySection } from '@/features/runtime-overview/components/runtime-summary-section';
