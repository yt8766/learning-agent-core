...
vi.mock('@/pages/runtime-overview/components/runtime-analytics-charts', () => ({
...
import { RuntimeAnalyticsSection } from '@/pages/runtime-overview/components/runtime-analytics-section';
