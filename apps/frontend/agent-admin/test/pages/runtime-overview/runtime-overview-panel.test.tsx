...
vi.mock('../../../src/pages/runtime-overview/components/runtime-architecture-panel', () => ({
  RuntimeArchitecturePanel: () => <div>architecture panel</div>
}));

vi.mock('../../../src/pages/runtime-overview/components/runtime-summary-section', () => ({
...
vi.mock('../../../src/pages/runtime-overview/components/runtime-analytics-section', () => ({
...
vi.mock('../../../src/pages/runtime-overview/components/runtime-queue-section', () => ({
