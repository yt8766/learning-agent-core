...
vi.mock('@/pages/skill-sources-center/skill-sources-source-card', () => ({
...
vi.mock('@/pages/skill-sources-center/skill-sources-manifest-card', () => ({
...
vi.mock('@/pages/skill-sources-center/skill-sources-installed-card', () => ({
...
vi.mock('@/pages/skill-sources-center/skill-sources-receipt-card', () => ({
