// apps/frontend/agent-admin/test/pages/workflow-lab/useWorkflowStream.test.ts
...
import { useWorkflowStream } from '../../../src/pages/workflow-lab/hooks/useWorkflowStream';
