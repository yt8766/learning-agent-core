...
import { AgentStateList, AgentStatusPanel } from '@/pages/agent-status/agent-status-panel';
import { ApprovalPanel } from '@/pages/approvals/approval-panel';
...
import { LearningPanel } from '@/pages/learning/learning-panel';
import { SessionListPanel } from '@/pages/session-list/session-list-panel';
