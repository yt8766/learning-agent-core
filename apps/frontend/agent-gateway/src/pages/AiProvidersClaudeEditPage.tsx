...
export function AiProvidersClaudeEditPage() {
  ...
  const connectivityConfigSignature = useMemo(() => {
    ...
    return [form.apiKey.trim(), form.baseUrl?.trim() ?? '', testModel.trim(), headersSignature, modelsSignature].join(
      '||'
    );
              ...
              <div className={styles.modelTestPanel}>
                ...
                <div className={styles.modelTestControls}>
                  <Select
                    ...
                    disabled={
                      saving || disableControls || isTesting || testStatus === 'loading' || availableModels.length === 0
                    }
                  />
                  <Button
                    ...
                    onChange={enabled =>
                      setForm(prev => {
                        ...
                        const restored = prev.cloak ??
                          lastCloakConfigRef.current ?? { mode: 'auto', strictMode: false, sensitiveWords: [] };
