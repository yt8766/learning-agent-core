...
export function SystemPage() {
  ...
  const otherLabel = useMemo(() => (i18n.language?.toLowerCase().startsWith('zh') ? '其他' : 'Other'), [i18n.language]);
      ...
      <div className={styles.content}>
        <Card className={styles.aboutCard}>
          ...
          <div className={styles.aboutInfoGrid}>
            <button type="button" className={`${styles.infoTile} ${styles.tapTile}`} onClick={handleInfoVersionTap}>
        ...
        <Card title={t('system_info.quick_links_title')}>
          ...
          <div className={styles.quickLinks}>
            ...
            <a href="https://help.router-for.me/" target="_blank" rel="noopener noreferrer" className={styles.linkCard}>
