...
- [docs/contracts/api/README.md](/docs/contracts/api/README.md)
- [docs/integration/frontend-backend-integration.md](/docs/integration/frontend-backend-integration.md)
- [docs/contracts/api/approvals.md](/docs/contracts/api/approvals.md)
...
- 后端 controller、service、SSE、运行时装配和鉴权说明放在 `docs/apps/backend/`；接口契约统一放在 `docs/contracts/api/`
