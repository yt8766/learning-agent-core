...
状态：current
文档类型：index
适用范围：`docs/conventions/`
最后核对：2026-04-26

本目录用于沉淀仓库级研发规范、工程约束、GitHub Flow、本地开发、测试和模板约定。
...
- [github-flow.md](/docs/conventions/github-flow.md)
- [local-development-guide.md](/docs/conventions/local-development-guide.md)
- [langgraph-app-structure-guidelines.md](/docs/conventions/langgraph-app-structure-guidelines.md)
- [project-template-guidelines.md](/docs/conventions/project-template-guidelines.md)
- [prompt-conventions.md](/docs/conventions/prompt-conventions.md)
