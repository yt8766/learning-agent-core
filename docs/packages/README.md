...
本目录镜像 `packages/*`，用于沉淀各共享包的职责、边界、契约与验证约束。
...
- [knowledge/README.md](/docs/packages/knowledge/README.md)
- [memory/README.md](/docs/packages/memory/README.md)
...
- `docs/packages/<pkg>/` 必须与真实 `packages/<pkg>` 对齐。
- 已删除包的历史资料进入 [archive](/docs/archive/README.md)。
