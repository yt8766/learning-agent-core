...
- 当前项目的 core 包规范：[current-core-package-guidelines.md](/docs/packages/core/current-core-package-guidelines.md)
- 当前 core 包合规检查：[current-core-package-audit.md](/docs/packages/core/current-core-package-audit.md)
- contract 边界主文档：[core-contract-guidelines.md](/docs/packages/core/core-contract-guidelines.md)
- Packages 阶段收官报告：[package-finalization-report.md](/docs/packages/core/package-finalization-report.md)
- Compat 入口收缩候选：[package-compat-sunset-candidates.md](/docs/packages/core/package-compat-sunset-candidates.md)
...
1. [当前 core 包规范](/docs/packages/core/current-core-package-guidelines.md)
2. [当前 core 包合规检查](/docs/packages/core/current-core-package-audit.md)
3. [core contract 规范](/docs/packages/core/core-contract-guidelines.md)
4. [Packages 分层与依赖约定](/docs/conventions/package-architecture-guidelines.md)
5. [Packages 目录说明](/docs/maps/packages-overview.md)
