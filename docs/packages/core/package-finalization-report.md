...
| `packages/tools`         | `@agent/tools`              | 包根 `src/index.ts`、`contracts/tool-registry.ts`、`contracts/tool-risk-classifier.ts`            | `approval/index.ts`、`connectors/index.ts`、`filesystem/index.ts`、`mcp/index.ts`、`registry/index.ts`、`runtime-governance/index.ts`、`sandbox/index.ts`、`scheduling/index.ts`、`watchdog/index.ts` | `definitions/`、`executors/`、`approval/`、`registry/`、`sandbox/`、`transports/`、`scaffold/`、`watchdog/`、`mcp/*registry*` |
| `packages/skill-runtime` | `@agent/skill-runtime`      | 包根 `src/index.ts`、`contracts/skill-runtime-facade.ts`                                          | 当前主要保留包根聚合，不额外依赖大量目录聚合层                                                                                                                                                        | `registry/`、`sources/`、`catalog/`、`install/`、`policies/`                                                                  |
...
- 删除 legacy 根文件 compat
  ...
  - `packages/skill-runtime/src/skill-registry.ts`、`src/agent-skill-loader.ts`
  - `packages/report-kit/src/data-report-*.ts`
  - `packages/tools/src/tool-registry.ts`、`src/tool-risk-classifier.ts`
  - `packages/adapters/src/chat/chat-model-factory.ts`、`src/llm/runtime-provider-factory.ts`
...
- 明确 facade 与真实宿主分离
  ...
  - `skill-runtime`：`contracts/skill-runtime-facade.ts`
