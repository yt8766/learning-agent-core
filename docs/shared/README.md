...
1. [shared-removal-completed.md](/docs/shared/shared-removal-completed.md)
2. [core-compat-boundary.md](/docs/shared/core-compat-boundary.md)
3. [shared-removal-feasibility.md](/docs/shared/shared-removal-feasibility.md)
...
- 新的共享包边界规则请改看 [docs/core/README.md](/docs/core/README.md) 与 [docs/package-architecture-guidelines.md](/docs/package-architecture-guidelines.md)
- 如果需要理解运行时、前后端或 agent 侧的当前真实宿主，请分别回到 `docs/runtime/`、`docs/backend/`、`docs/frontend/`、`docs/agents/`
- 不要再把本目录内容当成当前实现落位指南
