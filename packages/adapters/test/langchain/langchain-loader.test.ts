...
import { LangChainLoaderAdapter } from '../../src/langchain/loaders/langchain-loader.adapter';
import { mapLangChainDocumentToCoreDocument } from '../../src/langchain/shared/langchain-document.mapper';
