...
import { getSpecialistDisplayName, normalizeSpecialistDomain } from '@agent/shared';
...
const SPECIALIST_RULES: Array<{
  ...
  },
  {
    ...
    leadTokens: ['架构', '性能', 'bet', '组推', '服务', '负载', '技术', '重构', '代码'],
    domainInstruction: '聚焦架构、实现约束、技术风险、性能与可维护性。'
  }
];
