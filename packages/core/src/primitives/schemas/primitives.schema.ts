...
export const AgentRoleSchema = z.enum([AgentRole.MANAGER, AgentRole.RESEARCH, AgentRole.EXECUTOR, AgentRole.REVIEWER]);
...
export const ExecutionModeValues = ['standard', 'planning-readonly', 'plan', 'execute', 'imperial_direct'] as const;
...
export const SubgraphIdValues = ['research', 'execution', 'review', 'skill-install', 'background-runner'] as const;
export const SubgraphIdSchema = z.enum(SubgraphIdValues);
