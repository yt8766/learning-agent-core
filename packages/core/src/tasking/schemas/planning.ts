...
export const PlanModeSchema = z.enum(['intent', 'implementation', 'finalized', 'aborted']);

export const PlanModeTransitionRecordSchema = z.object({
  from: PlanModeSchema.optional(),
  to: PlanModeSchema,
  reason: z.string(),
  at: z.string()
});
...
export const CounselorSelectorConfigSchema = z.object({
  selectorId: z.string(),
  domain: z.string(),
  enabled: z.boolean(),
