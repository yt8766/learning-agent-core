...
import { buildLearningCenter, buildLearningCenterSummary } from '../src/centers/runtime-learning-center';
...
describe('runtime-learning-center', () => {
  it('builds full learning center projection with derived rule candidates', async () => {
    const result = await buildLearningCenter(createLearningFixture() as any);
  ...
  it('builds summary projection with derived rule candidates', async () => {
    const result = await buildLearningCenterSummary(createLearningFixture() as any);
