...
const CODE_FILES = [
  ...
  'apps/frontend/agent-admin/test/pages/runtime-overview/components/architecture-mermaid-card.test.tsx',
  'apps/frontend/agent-admin/test/pages/runtime-overview/components/runtime-architecture-panel.test.tsx',
