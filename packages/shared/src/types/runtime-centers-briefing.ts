...
export interface RuntimeCenterDailyTechBriefingRunStatRecord {
  runAt: string;
  itemCount: number;
  newCount: number;
  updateCount: number;
...
export interface RuntimeCenterDailyTechBriefingScheduleStateRecord {
  ...
  recentRunStats: RuntimeCenterDailyTechBriefingRunStatRecord[];
}

export interface RuntimeCenterDailyTechBriefingAuditRecord {
  messageKey: string;
  title: string;
...
export interface RuntimeCenterDailyTechBriefingCategoryRecord {
  category: RuntimeCenterDailyTechBriefingCategory;
  title: string;
  status: 'sent' | 'empty' | 'failed' | 'skipped';
  itemCount: number;
  ...
  auditRecords?: RuntimeCenterDailyTechBriefingAuditRecord[];
  helpful?: number;
  notHelpful?: number;
  sentAt?: string;
  error?: string;
...
export interface RuntimeCenterDailyTechBriefingRecord {
  ...
  categories: RuntimeCenterDailyTechBriefingCategoryRecord[];
}
